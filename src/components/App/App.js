...
import logo from "./jo_600_white.svg"
...
export default class App extends Component {
  componentDidMount() {
    ...
    this._typed = new Typed(this._subtitle, {
      ...
      loop: true,
      showCursor: false,
      strings: ['Jain Opticals Maharaja Chowk','Jain Opticals Priyanka Complex']
    })
  }
  ...
  _reset() {
    if (this._animation) {
      ...
      this._animation.addRandomSplats(random.int(100, 120))
    }
  }
  ...
  _tick = () => {
    if (this._animation) {
      ...
      const s = a * maxSplatRadius/2 + (1.0 - a) * minSplatRadius/2
